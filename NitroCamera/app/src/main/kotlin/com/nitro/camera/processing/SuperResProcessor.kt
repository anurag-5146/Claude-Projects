...
// Download ESRGAN TFLite from:
// https://tfhub.dev/captain-pool/esrgan-tf2/1?lite-format=tflite
// Place in app/src/main/assets/esrgan.tflite
private const val ESRGAN_MODEL = "esrgan.tflite"
private const val PATCH_SIZE = 128        // Process in 128×128 patches
private const val PATCH_OVERLAP = 8       // Overlap to avoid seam artefacts
